      ...
      <Card className="w-full max-w-lg max-h-[90vh] flex flex-col">
              ...
              {formData.password && (
                <div className="mt-2 p-3 bg-muted/30 rounded-lg space-y-2 border">
                  ...
                  <div className="grid grid-cols-2 gap-1 text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1">
                      <Check className={`h-3 w-3 ${/[^A-Za-z0-9]/.test(formData.password) ? 'text-green-500' : 'text-gray-300'}`} />
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="flex items-start gap-2">
                <Checkbox
                  ...
                  className="mt-1 flex-shrink-0"
                />
                <Label htmlFor="newsletter" className="text-xs font-normal cursor-pointer leading-relaxed">
        ...
        <CardFooter className="border-t pt-3 mt-2 flex flex-col space-y-1 flex-shrink-0">
          <div className="text-xs text-muted-foreground text-center">
            <p>By creating an account, you agree to receive occasional product updates.</p>
          </div>
